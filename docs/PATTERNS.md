...
- **Hängt (Hanging piece)** — a piece that's attacked and either undefended or
  only defended by units that lose material in the trade. Shown as a faint,
  slow-pulsing ring — deliberately the subtlest of all the hints.
